...
EGG_EVO_Repair =
{
	...
	{
		_inrepairzone = (_vec in list farp1);//your sensor zones in the mission named "farp1"
		if((_vec in list farp1) and _vec != player and speed _vec > -2 and speed _vec < 2 and position _vec select 2 < 2.0 and (local _vec)) then
		{
